...
try:
    ...
    from .first_rl_demo_environment import FirstRlDemoEnvironment
except (ModuleNotFoundError, ImportError):
    from models import FirstRlDemoAction, FirstRlDemoObservation
    from server.first_rl_demo_environment import FirstRlDemoEnvironment


# Create the app with web interface and README integration
app = create_app(
    FirstRlDemoEnvironment,
    FirstRlDemoAction,
    FirstRlDemoObservation,
    env_name="first_rl_demo",
